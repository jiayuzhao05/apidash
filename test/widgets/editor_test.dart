...
void main() {
  testWidgets('Testing Editor', (tester) async {
    ...
    final txtForm = find.byKey(const Key("2"));
    await tester.enterText(
      txtForm,
      'entering 123 for testing content body',
    );
  ...
  testWidgets(
    'TextFieldEditor preserves range selection on text update',
    (tester) async {
  ...
  testWidgets(
    'TextFieldEditor clamps selection when text shrinks',
    (tester) async {
      const initialValue = 'hello world';
      ...
      expect(
        ...
        inInclusiveRange(0, updatedValue.length),
      );
      expect(
